...
php artisan create:user {роль (user, admin, superadmin)} {логин} {пароль}

Указываем аргументами роль, логин, пароль.
Логин и пароль можно изменить в личном кабинете администратора в разделе Профиль
