        ...
        <div class="card">
            <div class="card-body">
                <div class="col-md-12 col-lg-8 col-xl-8">
                    {!! Form::open(['route' => 'motionsensors.store', 'method' => 'post', 'id' => 'switch_form', 'class' => 'form-horizontal form-bordered']) !!}
                    {{ csrf_field() }}
                    <div class="form-body">
                        {{ Form::bs_alert() }}
                        ...
                        <div class="form-group row ">
                            ...
                            <div class="col-sm-9">
                                ...
                                <div class="row" id="auto_object_div">
                                    <div class="col-sm-11 pr-0">
                                        <p>
                                            При создании датчика движения будет создан объект с таким же названием.
                                        </p>
                                    </div>
