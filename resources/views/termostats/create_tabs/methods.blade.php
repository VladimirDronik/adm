...
{{ Form::bs_autoselect('method_on', 'Метод при включении:', [], old('method_on'),
    false, false, [], null, 'Метод объекта влияния при срабатывании датчика температуры на включение') }}
...
{{ Form::bs_autoselect('method_off', 'Метод при выключении:', [], old('method_off'),
    false, false, [], null, 'Метод объекта влияния при срабатывании датчика температуры на выключение') }}
