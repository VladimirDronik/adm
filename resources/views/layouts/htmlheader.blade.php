...
<head>
    ...
    <link href="{{ asset('ela/css/lib/calendar2/semantic.ui.min.css') }}" rel="stylesheet">
    <link href="{{ asset('ela/css/lib/calendar2/pignose.calendar.min.css') }}" rel="stylesheet">
    <link href="{{ asset('ela/css/lib/owl.carousel.min.css') }}" rel="stylesheet" />
    <link href="{{ asset('ela/css/lib/owl.theme.default.min.css') }}" rel="stylesheet" />
