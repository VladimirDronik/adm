        ...
        <div class="card">
            <div class="card-body">
                <div class="col-md-12 col-lg-8 col-xl-8">
                    {!! Form::open(['route' => 'relays.store', 'method' => 'post', 'id' => 'relay_form', 'class' => 'form-horizontal form-bordered']) !!}
                    {{ csrf_field() }}
                    <div class="form-body">
                        {{ Form::bs_alert() }}
...
@section('scripts')
    ...
    <script>
        ...
        if ($('#relay_form input[name=gateway_type]:checked').val() == 'modbus') {
        ...
        $(document).ready(function () {
            $('#relay_form input[name=gateway_type]').change(function() {
                var options = $('#relay_form input[name=gateway_type]');
