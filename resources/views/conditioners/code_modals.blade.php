...
<div class="modal" id="modalReceivedСode">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalReceivedСodeTitle">Считан код</h5>
            </div>
            <div class="modal-body">
                Считан код: <input type="text" class="form-control input-default col-sm-12" id="receivedСode" size="15" value="">
                <br>
                <button type="button" class="btn btn-default" data-dismiss="modal">Считать заново</button>
                &nbsp;&nbsp;&nbsp;&nbsp;
...
<button type="button" id="modal_received_сode_init_btn" style="display: none;" data-toggle="modal" data-target="#modalReceivedСode">&nbsp;</button>
