            ...
            <tbody>
                ...
                <tr id="tr{{$camera->id}}">
                    ...
                    <td scope="row">
                        ...
                        @else
                            <a href="http://{{ request()->host() }}:8888/camera{{ $camera->id }}?muted=1&controls=0&autoplay=1" target="_blank"><img src="{{ $camera->image }}" onerror="this.src='{{ asset('ela/images/no-cam-image.jpg') }}'" width="120" height="80" loading="lazy"></img></a>
                        @endif
                    </td>
