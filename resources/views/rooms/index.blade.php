            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="{{ route('rooms.index') }}" class="btn btn-success m-b-10 m-l-5">Обновить</a>
                    </div>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 text-left">
                                            <button type="button" class="btn btn-info btn-xs" id="sortBtn{{ $room->id }}"
                                                    onclick="changeSort({{ $room->id }}, 'up');" >выше</button>

                                            <button type="button" class="btn btn-info btn-xs" id="sortBtn{{ $room->id }}"
                                                    onclick="changeSort({{ $room->id }}, 'down');" >ниже</button>
                                        </div>
                                    </div>
                                </td>
                                <td>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" data-dismiss="modal" onclick="store();">Добавить</button>
                    </div>
                </div>
            </div>
        </div>
