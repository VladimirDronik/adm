            ...
            <div class="card-body">
                <div class="col-md-12 col-lg-8 col-xl-8">
                    ...
                    <div class="form-body">
                        ...
                        <input type="hidden" id="event_idobject" name="event_idobject" value="{{  $manometr->iobject['id'] }}">
