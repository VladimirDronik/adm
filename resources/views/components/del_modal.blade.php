    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="del_modal_title">Подтверждение</h5>
            </div>
...
<button type="button" id="del_init_btn" style="display: none;" data-toggle="modal" data-target="#del_modal">&nbsp;</button>
