        ...
        <div class="card">
            <div class="card-body">
                <div class="col-md-12 col-lg-8 col-xl-8">
                    {!! Form::open(['route' => 'elements.store', 'method' => 'post', 'class' => 'form-horizontal form-bordered',
                    'id' => 'elements_form']) !!}
                        {{ csrf_field() }}
                        <div class="form-body">
                            ...
                            <div id="parent_div">
                                {{ Form::bs_autoselect('parent', 'Родительский эелемент:', $parents, old('parent'),
                                         false, false, [], null) }}
                            ...
                            <div id="handle_div">
                                ...
                                {{ Form::bs_autoselect('id_object', 'Привязанный объект:',  $objects, old('id_object'),
                                ...
                                {{ Form::bs_autoselect('handle', 'Идентификатор:', [], old('handle'),
