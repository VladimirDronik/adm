            ...
            <div class="card-body">
                <div class="col-md-12 col-lg-8 col-xl-8">
                    ...
                    <div class="form-body">
                        ...
                        {{ Form::bs_select('register_type', 'Тип*:', [], old('register_type', $register->register_type), ['required' => true]) }}
                        ...
                        <div id='registers_quantity' hidden>
                            {{ Form::bs_number('registers_quantity', 'Кол-во регистров*:', old('registers_quantity', $register->registers_quantity), ['min' => 1, 'max' => 125, 'required' => true]) }}
                        </div>
        ...
        $(document).ready(function () {
            ...
            function updateRegisterTypeSelect(protocol) {
                ...
                $.each(options, function (index, option) {
                    select.append(new Option(option.text, option.value, false, option.value == "{{ old('register_type', $register->register_type) }}" ? true : false));
                });
            }
