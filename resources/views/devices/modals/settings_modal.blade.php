            ...
            <div class="modal-body">
                ...
                @if($device->devtype->name == 'WB-LED')
                    <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            <input id="modalDevIp" class="form-control" name="ip_address" autocomplete="off" value="{{ $device->ip_address }}" size="3">
                        </div>
                    </div>
                    {{ Form::bs_radio('port', 'Порт JetHome*:', [0 => 'Serial0', 1 => 'Serial1'], old('port', $device->port), ['required' => true]) }}
                @else
                    <div class="form-group row">
                        <label class="control-label text-right col-md-2 label-fix" for="modalDevIp">
