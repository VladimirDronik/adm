...
@section('breadcrumbs')
    @includeIf('components.breadcrumbs', [
        'title' => 'Редактирование датчика влажности № '. $hygrostat->id_object,
        ...
        <div class="card">
            <div class="card-body">
                <div class="col-md-12 col-lg-8 col-xl-8">
                    {!! Form::model($hygrostat, ['route' => ['hygrostats.update', $hygrostat->id], 'id' => 'hygrostat_form', 'method' => 'put', 'class' => 'form-horizontal form-bordered']) !!}
                        {{ csrf_field() }}
                        <div class="form-body">
                            {{ Form::bs_alert() }}
...
@section('scripts')
    ...
    <script>
        ...
        const object_id = '{{ $hygrostat->id_object  }}';
        ...
        $(document).ready(function () {
            initHygrostatForm();
            initActionModal();
            initMethodsVar("{{ $hygrostat->object }}");
