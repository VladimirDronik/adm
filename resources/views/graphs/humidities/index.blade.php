...
@section('breadcrumbs')
    @includeIf('components.breadcrumbs', ['title' => 'Графики: влажность'])
@endsection
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <a href="{{ route('graphs.humidities.index') }}" class="btn btn-success m-b-10 m-l-5">Обновить</a>
                    </div>
                </div>
            </div>
        </div>
...
@section('scripts')
    ...
    <script>
        let url_graph = '{{ route('ajax.graphs.humidities.period.data') }}';
        ...
        $(document).ready(function(){
            ...
            function createAmChart(id, dates, values) {
                ...
                valueAxis.title.text = "Влажность (%)";

                var series = chart.series.push(new am4charts.LineSeries());
                series.dataFields.dateX = "date";
                series.dataFields.valueY = "temp";
                series.tooltipText = "Влажность (%): [bold]{valueY}[/]";
