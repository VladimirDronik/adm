...
class HomeObject extends Model
{
    ...
    /**
     * Метод для удаления объекта, созданного автоматически для датчика температуры, счетчика или диммера
    ...
    /**
     * Удаление объекта, созданного автоматически для счетчика, датчика температуры, универсального датчика или диммера.
