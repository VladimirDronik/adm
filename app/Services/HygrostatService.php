...
class HygrostatService
{
    ...
    /**
     * Удаление датчика влажности. Если связанный объект системный, то удаление объекта, метода, задачи расписания,
    ...
    /**
     * Создание датчика влажности. Если $data['type'] === 'auto',
    ...
    /**
     * Обновление датчика влажности. Если изменилось название и у датчика температуры системный объект, то
