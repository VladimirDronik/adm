...
function validateHygrostat() {
    ...
    let on_params = $("#hygrostat_form #method_on_params");
    ...
    let off_params = $("#hygrostat_form #method_off_params");
...
function initHygrostatForm() {
    ...
    function hideParamsFields(id) {
        $('#hygrostat_form #'+id+'_div').hide();
        $('#hygrostat_form #'+id).val('');
    }

    function showParamsFields(id, params) {
        $('#hygrostat_form #'+id+'_label').text(params+'*:');
        $('#hygrostat_form #'+id).val('');
        $('#hygrostat_form #'+id+'_div').show();
    }
