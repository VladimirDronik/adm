...
function initLightstatForm() {
    ...
    function hideParamsFields(id) {
        $('#lightstat_form #'+id+'_div').hide();
        $('#lightstat_form #'+id).val('');
    }

    function showParamsFields(id, params) {
        $('#lightstat_form #'+id+'_label').text(params+'*:');
        $('#lightstat_form #'+id).val('');
        $('#lightstat_form #'+id+'_div').show();
    }
