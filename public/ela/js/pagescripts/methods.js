...
function addMethod(data) {
    ...
    const html = `<div class="form-group row" id="div${data.id}">
                     ...
                     <div class="col-md-1" id="comment${data.id}"><img src="/ela/images/info.png" width="23" height="23" title="${data.comment}"></img></div>
...
function editMethod(data) {
    ...
    $('#commentI'+data.id).attr('title', data.comment);
